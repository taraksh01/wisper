...
const MODEL_KEYS: (keyof AppSettings)[] = ["engine_mode", "engine_provider", "engine_base_url", "voice_api_key", "voice_api_key_openai", "voice_api_key_groq", "voice_api_key_sarvam", "voice_api_key_custom", "voice_api_keys_openai", "voice_api_keys_groq", "voice_api_keys_sarvam", "voice_api_keys_custom", "engine_model", "engine_sarvam_mode", "local_model_file"];
...
function AppShell() {
  ...
  const TAB_FIELDS: Record<string, (keyof AppSettings)[]> = {
    ...
    engine: ["engine_mode", "engine_provider", "engine_base_url", "voice_api_key", "voice_api_key_openai", "voice_api_key_groq", "voice_api_key_sarvam", "voice_api_key_custom", "voice_api_keys_openai", "voice_api_keys_groq", "voice_api_keys_sarvam", "voice_api_keys_custom", "engine_model", "engine_sarvam_mode", "local_model_file"],
